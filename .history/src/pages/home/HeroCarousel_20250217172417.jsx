    ...
    <div className={`carousel-item ${i==1?"active":""}`}>
      ...
      <div className="carousel-content">
        ...
        <div className="d-flex gap-4">
          <Link to="/about-us" 
          className={`aboutUSCarouselBtn text-decoration-none cursor-pointer ${isMobile?"p-2 fs-3":"py-3 px-5"}`}>
            ABOUT US
          </Link>
          <Link to="services" 
          className={`servicesCarouselBtn text-decoration-none cursor-pointer ${isMobile?"p-2 fs-3":"py-3 px-5"}`}>
            SERVICES
          </Link>
        </div>
      </div>
