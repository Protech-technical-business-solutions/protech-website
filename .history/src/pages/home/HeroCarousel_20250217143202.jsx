...
const Carousel = () => {
  ...
  return (
<div id="protechCarouselAutoPlay" style={{marginBottom:"120px"}}
  ...
  <div className="carousel-inner">
    ...
    <div className={`carousel-item ${i==1?"active":""}`}>
      ...
      <div className="carousel-content">
        <h5 style={{fontSize:50}} className="mb-0">Welcome to</h5>
        <p style={{fontSize:80}} className="fw-bold mb-0">
          PRO<span className="text-theme">TECH</span>
        </p>
        <p style={{fontSize:30}}>Design, Build, Install & Maintain</p>
        <br />
        <div className="d-flex gap-4">
          <button className="aboutUSCarouselBtn py-3 px-5">
            ABOUT US
          </button>
          <button className="servicesCarouselBtn py-3 px-5">
            SERVICES
          </button>
        </div>
      </div>
