    ...
    <div className={`carousel-item ${i==1?"active":""}`}>
      ...
      <div className="carousel-content">
        ...
        <div className="d-flex gap-4">
          <a className={`aboutUSCarouselBtn text-decoration-none cursor-pointer ${isMobile?"":"py-3 px-5"}`}>
            ABOUT US
          </a>
          <a className={`servicesCarouselBtn text-decoration-none cursor-pointer ${isMobile?"":"py-3 px-5"}`}>
            SERVICES
          </a>
        </div>
      </div>
