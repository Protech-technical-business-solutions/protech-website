...
function FeatureCard(props){
  ...
  const {isMobile} = useContext(MyContext)
  return (
    <div style={{width:isMobile?"100%":320,height:isMobile?480:350}} 
    className={`card mx-5 ${props.BGcolorClass=="bg-white" ? "text-dark" : "text-white"} border-0 shadow-md pt-5 pb-3 px-3 ${props.BGcolorClass}`}>
