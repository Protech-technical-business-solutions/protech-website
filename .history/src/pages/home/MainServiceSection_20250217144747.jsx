...
const Services = () => {
  ...
  return (
    <div className={'container d-flex gap-5 flex-wrap'+(isMobile?"flex-row-reverse":"")} 
    style={{minHeight:841,
      backgroundImage:"url('/mainServiceSection/background.jpg')"}}>
        ...
        <div>
          ...
          <p style={{width:isMobile?"auto":470, fontSize:20, lineHeight:"33px"}}
          ...
          <p style={{width:isMobile?"auto":670, fontSize:15, lineHeight:"31px", color:"#666666"}}
          className="mt-3">
          ...
          <div className={`d-flex gap-4 mt-5 flex-wrap ${isMobile?"justify-content-center":""}`}>
        ...
        <div className={`d-flex align-items-center ${isMobile?"justify-content-center text-center":""}`}>
          <img style={{
            maxWidth:441,
            maxHeight:524,
            height: isMobile ? 400 :""
