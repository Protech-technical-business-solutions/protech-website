...
function FeatureCard(props){
  ...
  const {isMobile} = useContext(MyContext)
  return (
    <div style={{width:isMobile?"60%":320,height:isMobile?480:350}} 
    className={`card ${props.BGcolorClass=="bg-white" ? "text-dark" : "text-white"} border-0 shadow-md pt-5 pb-3 px-3 d-flex flex-column align-items-center ${props.BGcolorClass}`}>
