      ...
      backgroundImage:"url('/mainServiceSection/background.jpg')"}}>
        ...
        <div>
          ...
          <div style={{height:120}}>
            <h3 className='company-text text-dark' style={{fontSize:isMobile?57:37,lineHeight:"50px"}}>
            We offer the best services
            </h3>
            <h3 className='company-text text-dark' style={{fontSize:isMobile?57:37,lineHeight:"50px"}}>
            for our clients
          ...
          <p style={{width:isMobile?"auto":470, fontSize:isMobile?30:20, lineHeight:"33px"}}
          ...
          <p style={{width:isMobile?"auto":670, fontSize:isMobile?24:15, lineHeight:"31px", color:"#666666"}}
          className="mt-3">
          ...
          <div className="d-flex gap-4 mt-4 flex-wrap">
            ...
            className="border border-theme border-2 px-3 py-3">
                ...
                <p style={{fontSize:isMobile?27:15, lineHeight:"31px", color:"#666666"}}
                className="mt-3">
                  {service.content}
                </p>
            </div>
          ...
          <div className={`d-flex gap-4 flex-wrap ${isMobile?"justify-content-center pb-4 mt-5 mb-3":"mt-5"}`}>
              ...
              className="btn-getQuote d-flex align-items-center">
                  <span className='mx-3' style={{fontSize:isMobile?30:18}}>
                    READ MORE
                  </span>
              </button>
              <button style={{height:50, 
