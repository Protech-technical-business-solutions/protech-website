...
className="carousel slide carousel-fade" data-bs-ride="carousel">
  ...
  <div className="carousel-inner">
    ...
    <div className={`carousel-item ${i==1?"active":""}`}>
      <img src={`/carousel/${i}.jpg`} className="d-block w-100" style={{maxHeight:isMobile?350:855}} alt="..."/>
      <div className="carousel-content">
        <h5 style={{fontSize:isMobile?50:50}} className="mb-0">Welcome to</h5>
        <p style={{fontSize:isMobile?60:80}} className="fw-bold mb-0">
        ...
        <div className="d-flex gap-4">
          <Link to="/about-us" 
          className={`aboutUSCarouselBtn text-decoration-none cursor-pointer ${isMobile?"p-3":"py-3 px-5"}`}>
            ABOUT US
          </Link>
          <Link to="services" 
          className={`servicesCarouselBtn text-decoration-none cursor-pointer ${isMobile?"p-3":"py-3 px-5"}`}>
            SERVICES
          </Link>
        </div>
      </div>
