...
className="carousel slide carousel-fade" data-bs-ride="carousel">
  ...
  <div className="carousel-inner">
    ...
    <div className={`carousel-item ${i==1?"active":""}`}>
      <img src={`/carousel/${i}.jpg`} className="d-block w-100" style={{maxHeight:10000}} alt="..."/>
      <div className="carousel-content">
        ...
        <div className="d-flex gap-4">
          <button className={`aboutUSCarouselBtn ${isMobile?"":"py-3 px-5"}`}>
            ABOUT US
          </button>
          <button className={`servicesCarouselBtn ${isMobile?"":"py-3 px-5"}`}>
            SERVICES
          </button>
        </div>
      </div>
