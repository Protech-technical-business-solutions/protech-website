                ...
                {allServices.map((service,idx,_)=>
                    ...
                    style={{
                        ...
                        <div className={isMobile?"":"container"}>
                            ...
                            <br />
                            <div className={`d-flex flex-wrap justify-content-around ${isMobile&&"flex-column justify-content-center text-center"}`}>
                                <div>
                                    <img style={{
                                ...
                                className="flex-gd-flex justify-content-center">
                                    <ul>
