                ...
                {allServices.map((service,idx,_)=>
                    ...
                    style={{
                        ...
                        <div className={isMobile?"":"container"}>
                            ...
                            <br />
                            <div className={`d-flex flex-wrap justify-content-around ${isMobile&&"flex-column justify-content-center mx-auto"}`}>
                                <div>
                                    <img style={{
                                        width:isMobile?"70%":380, height:"auto",
                                    }}
                                    src={service.image} alt="Service Image" className="mx-auto" />
                                </div>
                                <div style={{
                                    minHeight:234,
                                }}
