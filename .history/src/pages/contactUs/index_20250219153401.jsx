            ...
            <div className={isMobile?"":"container"}>
                ...
                <form className={isMobile?"mx-5":""}>
                    <div className="mb-3">
                        ...
                        <input className="form-control form-control-lg border" id="nameInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <input type="email" className="form-control form-control-lg border" id="emailInputeContact" aria-describedby="emailHelp"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        }} 
                        for="addressInputContact" className="form-label">Address</label>
                        <input className="form-control form-control-lg border" id="addressInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <textarea className="form-control form-control-lg border" id="messageInputContact"/>
