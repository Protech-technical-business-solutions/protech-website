        ...
        <div>
            ...
            <div className={isMobile?"":"container"}>
                ...
                <form className={isMobile?"mx-5":""}>
                    <div className="mb-3">
                        <label for="nameInputContact" className="form-label">Name</label>
                        <input className="form-control" id="nameInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label for="emailInputeContact" className="form-label">Email address</label>
                        <input type="email" className="form-control" id="emailInputeContact" aria-describedby="emailHelp"/>
                    </div>
                    <div className="mb-3">
                        <label for="addressInputContact" className="form-label">Address</label>
                        <input className="form-control" id="addressInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label for="messageInputContact" className="form-label">Message</label>
                        <textarea className="form-control" id="messageInputContact"/>
                        <div className="form-text">We respond within 2 days.</div>
                    </div>
                    <div className="d-flex justify-content-end">
                        <button type="submit" className="btn btn-outline-theme">Submit</button>
                    </div>
                </form>
                <br /><br /><br /><br />
            </div>
