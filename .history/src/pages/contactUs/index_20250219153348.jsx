            ...
            <div className={isMobile?"":"container"}>
                ...
                <form className={isMobile?"mx-5":""}>
                    <div className="mb-3">
                        ...
                        <input className="form-control-lg" id="nameInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <input type="email" className="form-control-lg" id="emailInputeContact" aria-describedby="emailHelp"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <input className="form-control-lg" id="addressInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <textarea className="form-control-lg" id="messageInputContact"/>
