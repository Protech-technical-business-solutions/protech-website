            ...
            <div className={isMobile?"":"container"}>
                ...
                <form className={isMobile?"mx-5":""}>
                    <div className="mb-3">
                        ...
                        <input className="form-control-lf" id="nameInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <input type="email" className="form-control-lf" id="emailInputeContact" aria-describedby="emailHelp"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <input className="form-control-lf" id="addressInputContact"/>
                    </div>
                    <div className="mb-3">
                        <label style={{
                            fontSize:isMobile?27:""
                        ...
                        <textarea className="form-control-lf" id="messageInputContact"/>
