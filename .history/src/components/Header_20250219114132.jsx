  ...
  return (
    <header className="w-100">
      ...
      <div className='bg-white'>
        <div className={`container d-flex align-items-center flex-wrap ${isMobile?"":""}`}>
      ...
      <nav className="bg-black2grey">
        <div className={`d-flex ${isMobile?"justify-content-between mx-4":"justify-content-between container"}`}>
          {isMobile ?
            <>
