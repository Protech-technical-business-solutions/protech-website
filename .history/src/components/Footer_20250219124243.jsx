    ...
    <section>
      <div className="px-4 py-4 d-flex flex-wrap justify-content-around bg-theme text-white fw-bold">
        ...
        <div className='d-flex align-items-center mt-2'>
          <button className={`btn-footer-quote ${isMobile?"p-5":"px-5 py-4"} rounded-2 border-0 text-center fw-bold font-Raleway`}>
            GET A QUOTE
          </button>
        </div>
      </div>
      ...
      <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom container">
        ...
        <div>
          <a href="#" className="me-4 text-reset">
            <FaLinkedin className='text-light text-hover-theme' />
          </a>
          <a href="#" className="me-4 text-reset">
            <FaGoogle className='text-light text-hover-theme' />
          </a>
          <a href="#" className="me-4 text-reset">
            <FaInstagram className='text-light text-hover-theme' />
          </a>
          <a href="#" className="me-4 text-reset">
            <TiSocialFacebook className='text-light text-hover-theme' />
          </a>
        </div>
      </section>
