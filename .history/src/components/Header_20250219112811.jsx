  ...
  return (
    <header className="w-100">
      ...
      <div className='bg-white'>
        <div className={`container d-flex align-items-center flex-wrap ${isMobile?"justify-content-center flex-column":""}`}>
          <div className={`${isMobile?"":"flex-grow-1"} mb-1`}><img src="/logo2.svg" alt="Logo" height={95} /></div>
          <div className={`${isMobile?"":"d-flex align-items-center justify-content-between gap-5"}`}>
