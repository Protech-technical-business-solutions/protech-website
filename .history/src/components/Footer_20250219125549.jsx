        ...
        <div className="text-center text-md-start mt-5">
          <div className={`mt-3 ${isMobile?"column":"row"}`}>
            ...
            <div className="col-md-8 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              className="text-uppercase fw-bold mb-4 mt-3">Quick Links</h6>
            ...
            <div className="col-md-8 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              className="text-uppercase fw-bold mb-4 mt-3">Services</h6>
            ...
            <div className="col-md-8 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              className="text-uppercase fw-bold mb-4 mt-3">Contact</h6>
