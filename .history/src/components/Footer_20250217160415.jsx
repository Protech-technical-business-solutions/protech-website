          ...
          <div className="row mt-3">
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              {allServices.map(service=>
                <p><a href="#" className="text-reset">{service.title}</a></p>
              )}
            </div>
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              <h6 className="text-uppercase fw-bold mb-4">Contact</h6>
              <p><IoLocationSharp className='me-3' /> Riyadh, Saudi Arabia</p>
              <p><MdEmail className='me-3'/>ayyubsayeed@protech-saudi.com</p>
              <p><MdEmail className='me-3'/>imran@protech-saudi.com</p>
              <p><FaPhone className='me-3'/> + 966 572744600</p>
              <p><FaPhone className='me-3'/> + 966 580681213</p>
            </div>
          </div>
        </div>
      </section>
