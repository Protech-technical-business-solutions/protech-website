        ...
        <div className="text-center text-md-start mt-5">
          <div className={`mt-3 ${isMobile?"column":"row"}`}>
            ...
            <div className="col-md-8 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              className="text-uppercase fw-bold mb-4">Quick Links</h6>
              <p style={{fontSize:isMobile?30:""}}><a href="#" className="text-light text-hover-theme text-decoration-none">Home</a></p>
              <p style={{fontSize:isMobile?30:""}}><a href="#" className="text-light text-hover-theme text-decoration-none">About us</a></p>
              <p style={{fontSize:isMobile?30:""}}><a href="#" className="text-light text-hover-theme text-decoration-none">Services</a></p>
              <p style={{fontSize:isMobile?30:""}}><a href="#" className="text-light text-hover-theme text-decoration-none">Site Works</a></p>
              <p style={{fontSize:isMobile?30:""}}><a href="#" className="text-light text-hover-theme text-decoration-none">Contact us</a></p>
            </div>
            <div className="col-md-8 col-lg-2 col-xl-2 mx-auto mb-4">
              <h6 style={{
                fontSize:isMobile?30:""
              }}
              className="text-uppercase fw-bold mb-4">Services</h6>
