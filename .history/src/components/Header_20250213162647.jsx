    ...
    <header className="w-100">
      ...
      <div className='bg-white'>
        <div className={`container d-flex align-items-center flex-wrap ${isMobile?"justify-content-center":""}`}>
          ...
          <div className={`d-flex align-items-center justify-content-between ${isMobile?"justify-content-start container":"gap-5"} flex-wrap`}>
      ...
      <nav className="bg-black2grey">
        <div className={`${isMobile ? "mx-2" :"container"} d-flex justify-content-between`}>
